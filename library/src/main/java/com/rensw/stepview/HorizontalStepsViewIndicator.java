...
public class HorizontalStepsViewIndicator extends View {
    ...
    private int mUnSignPaintLineColor = ContextCompat.getColor(getContext(), R.color.color_FF);//定义默认未完成线的颜色  definition
    public int mSignPaintLineColor = ContextCompat.getColor(getContext(), R.color.color_9C);//定义默认未完成线的颜色  definition
